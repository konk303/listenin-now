...
(function($) {
    ...
    Class.Tracks = $.myUtil.createClass({
        ...
        createEachDom: function(i, data) {
            ...
            $('<img />').attr({
                "src": data.image[0]["#text"] || "http://dl.getdropbox.com/u/1035457/opensocial/mixi/listenin_now/static/noimage.png",
...
//                 alert("エラー:\n" + res.errors.join("\n"));
        ...
        createEachDom: function(i,data) {
            ...
            $('<br />').appendTo(dt);
            //image
            var img = data.artworkUrl100 || "http://dl.getdropbox.com/u/1035457/opensocial/mixi/listenin_now/static/noimage.png";
    ...
    Class.LoadingImage = $.myUtil.createClassSingleton({
        init: function() {
            this.img = $('<img />').attr({
                src: "http://dl.getdropbox.com/u/1035457/opensocial/mixi/listenin_now/static/ajax-loader.gif",
                alt: "now loading",
                titile: "now loading"
            })
